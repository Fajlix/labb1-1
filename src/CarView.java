...
public class CarView extends JFrame{
    ...
    private void initComponents(String title) {
        ...
        this.setTitle(title);
        this.setPreferredSize(new Dimension(CarModel.X + 20, CarModel.Y +CarModel.Y/15 + 240));
        ...
        controlPanel.setPreferredSize(new Dimension((CarModel.X / 2) + 4, 200));
        this.add(controlPanel);
        controlPanel.setBackground(Color.CYAN);

        startButton.setBackground(Color.blue);
        startButton.setForeground(Color.green);
        startButton.setPreferredSize(new Dimension(CarModel.X / 5 - 15, 200));
        this.add(startButton);

        stopButton.setBackground(Color.red);
        stopButton.setForeground(Color.black);
        stopButton.setPreferredSize(new Dimension(CarModel.X / 5 - 15, 200));
        this.add(stopButton);
